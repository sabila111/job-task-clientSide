      ...
      <div className="hero-content flex-col lg:flex-row-reverse gap-52">
        ...
        <div className="card  w-full max-w-sm shrink-0 ">
          ...
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className=" mt-5">
              <button className="px-4 py-3 rounded-lg  bg-blue-800 text-white">Login</button>
            </div>
          ...
          <p className="text-center mt-4">Don't have an account? Please <Link className=" font-bold" to={'/register'}>Register</Link></p>
